...
public class WatchDataWindow {
    public WatchDataWindow(KeepDataHelper dataHelper, Stage ownerStage, int watchTimeMs, List<Person> people) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        WatchPeopleController controller = new WatchPeopleController(dataHelper, watchTimeMs, people);
